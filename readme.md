...
🌐 Live Demo: https://rag-assistant.streamlit.app
...
Grounded answer synthesis & audio transcription

RAG Orchestration

LangChain (LCEL)

Chain execution, prompt management, and retrievers

Vector Database

Qdrant Client

In-memory vector store for cosine similarity indexing
...
Connect your GitHub repository (your-username/rag-assistant).
